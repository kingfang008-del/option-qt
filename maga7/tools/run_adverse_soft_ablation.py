#!/usr/bin/env python3
"""Ablation: causal 5m adverse soft gate (tox tighten / soft exit)."""
...
VARIANTS = {
    ...
    # Narrow: deep MAE + still adverse + opt red + no quote MFE
    "narrow_tox15": {
        "adverse_soft": {
            **BASE,
            **NARROW,
...
def _metrics(summary: dict, daily) -> dict:
    ...
    return {
        ...
        "n_day_le_m5": n_le5,
        "n_adverse_soft": summary.get("n_adverse_soft"),
        "n_adverse_soft_armed": summary.get("n_adverse_soft_armed"),
...
def main() -> None:
    ...
    ap.add_argument("--tag-prefix", default="research_adverse_soft_ablation")
    args = ap.parse_args()
