...
class StrategyConfig:
    ...
    EXIT_FAST_REQUOTE_INTERVAL_SECONDS: float = 0.25
    EXIT_FAST_REQUOTE_CANCEL_SETTLE_SECONDS: float = 0.05
    ...
    STOP_EXIT_FAST_MAX_RETRIES: int = 3
    STOP_EXIT_FAST_WAIT_SECONDS: int = 1
    STOP_EXIT_FAST_CANCEL_SETTLE_SECONDS: float = 0.25
    ...
    IBKR_API_MAX_MESSAGES_PER_SECOND: int = 30
