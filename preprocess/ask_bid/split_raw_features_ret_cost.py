...
SOURCE_DIR = Path.home() / "train_data/ret_cost_quote_features_raw" 

# 【必须修改】定义新的、分离的训练集和验证集输出目录
TRAIN_DIR = Path.home() / "train_data/ret_cost_quote_features_train"
VAL_DIR = Path.home() / "train_data/ret_cost_quote_features_val"
