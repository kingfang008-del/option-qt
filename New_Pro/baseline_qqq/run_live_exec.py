...
import baseline_paths  # noqa: F401  — sys.path for strategy/ signal_engine/ oms/ infra/
...
async def main():
    ...
    # OMS 启动前只清 Redis dashboard projection；交易状态只从 OMS 内存/PG 快照恢复，
    # 不再允许 Redis 仓位投影参与策略或交易同步。
    try:
