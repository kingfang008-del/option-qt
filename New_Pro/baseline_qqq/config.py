...
# ================= Session / Entry (V0 ↔ qqq_btc replay) =================
# 09:30=0 与 replay session_entry_start_bar 对齐；legacy V0 默认 45 可通过 env 覆盖
START_MINUTE = int(os.environ.get("START_MINUTE", "30"))
BIDIRECTIONAL_DISLOCATION_ENTRY_ENABLED = _env_flag("BIDIRECTIONAL_DISLOCATION_ENTRY_ENABLED", False)
...
# qqq_btc live 默认关 FAST_GATE(choose_entry 已做 spread 6%);legacy 默认开
FAST_GATE_ENABLED = _env_flag("FAST_GATE_ENABLED", True)
...
# 策略内核：仅 V0（strategy/core_v0.py）；TREND/V1 已归档 archive/
...
COOLDOWN_MINUTES      = int(os.environ.get("COOLDOWN_MINUTES", "60"))  # qqq_btc: 5(对齐 replay cooldown_bars)
