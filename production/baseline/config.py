...
EXECUTION_DELAY_SECONDS = int(os.environ.get("EXECUTION_DELAY_SECONDS", "1"))
...
BACKTEST_1S_DISABLE_ICEBERG = _env_flag("BACKTEST_1S_DISABLE_ICEBERG", BACKTEST_1S_GENTLE_EXECUTION)
