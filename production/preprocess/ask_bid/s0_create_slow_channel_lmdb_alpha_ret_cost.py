...
PARQUET_ROOT = Path(Path.home() / 'train_data/ret_cost_quote_features_val').parent
OUTPUT_DIR = Path('/mnt/s990/data/ret_cost')
...
def run_stage(stage, config):
    ...
    root_path = PARQUET_ROOT / f"ret_cost_quote_features_{stage}"
    output_path = OUTPUT_DIR / f"{stage}_ret_cost_alpha.lmdb"
