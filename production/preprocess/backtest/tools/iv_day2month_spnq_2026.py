    ...
    try:
        ...
        for file_type, group_config in file_groups.items():
            ...
            for file in daily_files:
                ...
                try:
                    # 解析日期: SYMBOL_YYYYMMDD.parquet 或 SYMBOL_YYYY-MM-DD.parquet
                    ...
                    if len(parts) >= 2:
                        ...
                        if len(date_part) == 8 and date_part.isdigit():
                            ...
                            year_month_fmt = date_part[:7] # YYYY-MM
                            monthly_groups[year_month_fmt].append(file)
                except Exception:
                    continue
...
def merge_monthly_options_data_multiprocess(base_path="~/backtest/nq_2603_options_day_iv", 
                                            output_base_path="~/backtest/nq_2603_options_monthly_iv",  
