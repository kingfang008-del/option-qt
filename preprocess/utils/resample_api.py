...
def process_symbol(symbol):
    minute_dir = Path.home() / "data/stocks_parquet" / symbol
    second_dir = Path.home() / "data/spnq_stock_test_extended_hours" / symbol
    output_base = Path.home() / "data/stocks_parquet_resampled"
