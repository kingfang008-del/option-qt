...
def evaluate_entry_liquidity(
    *,
    ...
    cfg: Any,
    spread_threshold_override: Any = None,
) -> Dict[str, Any]:
    ...
    spread_threshold = (
        _to_float(spread_threshold_override, 0.0)
        if spread_threshold_override is not None
        else get_entry_spread_threshold(curr_f, alpha_z, cfg)
    )
